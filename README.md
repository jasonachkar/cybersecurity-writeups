...
- [AWS IAM at Scale: Federation, Delegation, and Guardrails](cloud-security/iam-at-scale.md) —  · 2026-07-25 · 13 min
- [AWS Multi-Account Landing Zones: Guardrails and Control-Plane Isolation](cloud-security/multi-account-landing-zones.md) —  · 2026-07-25 · 10 min
- [Cloud Detection Engineering: Durable Telemetry, High-Signal Analytics and Safe Response](cloud-security/cloud-detection-and-response.md) —  · 2026-07-25 · 7 min
- [Cloud Network Segmentation and Egress Control: Routing, Private Endpoints and Failure Domains](cloud-security/cloud-network-segmentation.md) —  · 2026-07-25 · 8 min
- [Cloud Security overview](cloud-security/index.md) —  · 2026-07-25 · 2 min
- [Kubernetes Multi-tenancy: Boundaries, Isolation, and Operations](cloud-security/kubernetes-multi-tenancy.md) —  · 2026-07-25 · 10 min
- [Serverless Security Engineering: Event Trust, Function Identity and Runtime Reuse](cloud-security/serverless-security.md) —  · 2026-07-25 · 9 min

### 💻 Application Security

- [API and Microservice Trust Boundaries: Workload Identity, User Context and Downstream Authorization](appsec/api-microservices-threat-modeling.md) —  · 2026-07-25 · 9 min
- [Application Security overview](appsec/index.md) —  · 2026-07-25 · 2 min
- [Engineering Tenant Isolation for a Multi-tenant SaaS Platform](appsec/saas-multitenancy-isolation.md) —  · 2026-07-25 · 12 min
- [Layered Runtime Application Protection: WAF, In-Process Controls and eBPF Enforcement](appsec/runtime-protection-rasp-waf.md) —  · 2026-07-25 · 8 min
- [OAuth 2.0 and OpenID Connect Security Engineering](appsec/oauth2-oidc-deep-dive.md) —  · 2026-07-25 · 9 min
- [Threat-Driven Security Architecture for AI Agents](appsec/ai-agent-security.md) —  · 2026-07-23 · 35 min

### 🛡️ DevSecOps

- [DevSecOps overview](devsecops/index.md) —  · 2026-07-25 · 2 min
- [Infrastructure as Code Security and Policy Engineering](devsecops/iac-security-and-policy-as-code.md) —  · 2026-07-25 · 12 min
- [Secrets Management Engineering: Identity, Delivery, Rotation and Runtime Exposure](devsecops/secrets-management.md) —  · 2026-07-25 · 9 min
- [Secure CI/CD Pipeline Architecture and Trust Boundaries](devsecops/secure-cicd-pipeline-design.md) —  · 2026-07-25 · 12 min
- [SecureObs: Customer-side CI Security Scanning with a Multi-tenant Findings Platform](devsecops/secureobs-multitenant-security-scanner.md) —  · 2026-07-25 · 15 min
- [Software Supply-chain Evidence: SBOMs, Provenance, Signing, and Verification](devsecops/supply-chain-sbom-signing.md) —  · 2026-07-25 · 12 min

### 🕵️ Threat Intelligence

- [Attack Path Analysis: Preconditions, Reachability and Evidence-Backed Control Breaks](threat-intel/attack-path-analysis.md) —  · 2026-07-25 · 10 min
- [Cloud Incident Case Studies: Evidence, Chronology, and Control Lessons](threat-intel/cloud-breach-case-studies.md) —  · 2026-07-25 · 7 min
- [Threat Intelligence overview](threat-intel/index.md) —  · 2026-07-25 · 2 min
...
- [CompTIA Security+ SY0-701 study notes](docs/certification-notes/security-plus/README.md) —  · 2026-07-25 · 4 min
- [Microsoft SC-500 study notes](docs/certification-notes/sc-500/README.md) —  · 2026-07-25 · 6 min
