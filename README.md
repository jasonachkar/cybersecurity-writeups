...
- [Implementing Security Gates in CI/CD Pipelines](docs/tutorials/ci-cd-gates) — DevSecOps, CI/CD, SAST, SCA (+4) · 2024-06 · 25 min
- [Securing Azure Entra ID: A Zero Trust Approach](docs/tutorials/securing-entra-id) — Azure, Entra ID, IAM, Zero Trust (+3) · 2024-05 · 25 min
- [security-plus](docs/certification-notes/security-plus)
- [oauth-misconfigurations](docs/research/oauth-misconfigurations)
- [threat-modeling-saas](docs/research/threat-modeling-saas)
- [azure-firewall-walkthrough](docs/tutorials/azure-firewall-walkthrough)
- [azure-landing-zone](docs/tutorials/azure-landing-zone)
- [detection-engineering-sentinel](docs/tutorials/detection-engineering-sentinel)
- [owasp-api-security-top-10](docs/tutorials/owasp-api-security-top-10)

### 🔬 Research

- [Advanced Cloud Security Engineering: IAM, DevSecOps, Architecture & Detection](docs/research/enterprise-cloud-security-engineering) — Cloud Security, IAM, DevSecOps, Detection Engineering (+4) · 2026-06 · 55 min
